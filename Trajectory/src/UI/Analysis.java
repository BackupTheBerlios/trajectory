...
public class Analysis extends javax.swing.JFrame {
   ...
   public static int getAnimationSpeedValue(){
    ...
    // TODO: BE multiplying each time is expansive, simply increment the time.
    ...
    // TODO: BE C simplify method -> instead of looping often loop only once, set all vars.
    //       should reduce computing time around several hundred percents.
 ...
 public static void computeFinalValues(Vector<MovingBody> positions, Setting setting){
  ...
  private void initComponents() {
    ...
    jSliderAnimationSpeed.setMinimum(5);
