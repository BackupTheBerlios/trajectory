...
public class TrajectoryUI extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jMenuItemChooseParameters = new javax.swing.JMenuItem();
        ...
        jMenuItemChooseParameters.setText("Choose Parameters...");
        jMenuItemChooseParameters.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemChooseParametersActionPerformed(evt);
            }
        });
        jMenuSet.add(jMenuItemChooseParameters);
...
private void jMenuItemChooseParametersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemChooseParametersActionPerformed
  UserInputChooseParameters dialog = new UserInputChooseParameters();
  //dialog.setDefaultCloseOperation(javax.swing.WindowConstants.HIDE_ON_CLOSE);
  dialog.setAlwaysOnTop(true);
  dialog.setVisible(true);
  dialog.setModal(true);
}//GEN-LAST:event_jMenuItemChooseParametersActionPerformed
    /**
    ...
    private javax.swing.JMenuItem jMenuItemChooseParameters;
